          ...
          <Box sx={{ minWidth: 800 }}>
            ...
            <TableContainer>
              <Table>
                ...
                <TableBody>
                  {itemsKeywords.length !== 0 &&
                    itemsKeywords.map((customer) => {
              ...
              {itemsKeywords.length === 0 && !isKeywordsLoading && (
